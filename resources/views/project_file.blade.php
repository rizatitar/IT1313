...
<body>
    <div>
        ...
        <div class="projectContent">
            <p class="projectText">PROJECT
                <span><a href="{{ config('app.url')}}/project">
                    <button type="button" class="btn btn-light" id="newProject">Back</button>
                </a>
                ...
                <div class="row w-100">
                        <div class="col-md-2">
                            <div class="card border-dark mx-sm-1 p-3">
                                <span class="text-center"><svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="currentColor" class="bi bi-file-code-fill" viewBox="0 0 16 16">
                                ...
                                <div class="text-dark text-center mt-3"><h6>HTML</h6></div>
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="card border-dark mx-sm-1 p-3">
                                ...
                                <div class="text-dark text-center mt-3"><h6>CSS</h6></div>
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="card border-dark mx-sm-1 p-3">
                                ...
                                <div class="text-dark text-center mt-3"><h6>JS</h6></div>
                            </div>
                        </div>
                     </div>
                </div>
